...
export const EditMakerPuzzle = ({ id,setShow }) => {
                ...
                loading ?
                    ...
                    <>
                        ...
                        <div className="d-flex mt-5">
                            <button className='btn btn-warning rounded-0 fw-bold fs-5' style={{ borderLeft: '6px solid #000' }} onClick={()=>setShow(false)}>edit</button>

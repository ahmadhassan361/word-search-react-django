...
import { EditMakerPuzzle } from './EditMakkerPuzzle';

export const MakerEdit = () => {
    ...
    const fetchGame = async () => {
        ...
        let updateTemp = Array(32).fill('')
        for (let index = 0; index < wordsLists.length; index++) {
            updateTemp[index] = wordsLists[index];
            
        }

            console.log(updateTemp)
            setInputs(updateTemp)
            console.log(updateTemp)
    ...
    const handleSubmit = async () => {
        ...
        {
            console.log(valData,key,id)
            const res = await APIClient.updateGame(
               valData, key, id
                )
                console.log(res)
                console.log("save")
    ...
    return (
        ...
        
        {
            ...
            {
                id !== null ?
                <EditMakerPuzzle id={id} setShow={setshow} /> : <></>  
            }
            </>
  :      
        <div className='mt-5'>
